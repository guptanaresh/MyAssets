...
- (void)handleSingleTap {
    if ([delegate respondsToSelector:@selector(photoView:gotSingleTapAtPoint:)])
        [delegate photoView:self gotSingleTapAtPoint:tapLocation];
}

- (void)handleDoubleTap {
    if ([delegate respondsToSelector:@selector(photoView:gotDoubleTapAtPoint:)])
        [delegate photoView:self gotDoubleTapAtPoint:tapLocation];
}

- (void)handleTwoFingerTap {
    if ([delegate respondsToSelector:@selector(photoView:gotTwoFingerTapAtPoint:)])
        [delegate photoView:self gotTwoFingerTapAtPoint:tapLocation];
}
